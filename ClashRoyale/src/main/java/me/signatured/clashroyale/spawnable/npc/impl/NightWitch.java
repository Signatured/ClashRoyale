...
@GenerateCard(key = "NPC_NIGHT_WITCH", name = "Night Witch", rarity = ClashRarity.LEGENDARY, arena = ArenaType.ARENA_8, cost = 4)
public class NightWitch extends ClashNpc {
	...
	public ItemStack getMainHand() {
		return ItemBuilder.of(Material.BLAZE_ROD).build();
	}
