...
@GenerateCard(key = "NPC_VALKYRIE", name = "Valkyrie", rarity = ClashRarity.RARE, arena = ArenaType.ARENA_1, cost = 4)
public class Valkyrie extends SkinnedNpc {
	...
	public ItemStack getMainHand() {
		return ItemBuilder.of(Material.IRON_AXE).build();
	}
