...
@GenerateCard(key = "NPC_KNIGHT", name = "Knight", rarity = ClashRarity.COMMON, arena = ClashArena.ARENA_1, cost = 3)
public class Knight extends ClashNpc implements IClashNpc {
